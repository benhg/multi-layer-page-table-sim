 ...
 * We use structs to model hardware structures like TLBs, page table walkers,
 * etc.
 */
 ...
 * Basically, it's a struct of pointers to the data structures you need to run
 * the program
 */
typedef struct ptw_sim_context {
  ...
  // TODO: add backend management pointers here for easy programming of falid
  // page tables
